...
dir.create("/home/emancini/Dropbox (CRG)/Personal_Estefania/Network/selectedEventsHs2/convTotal")
dir2print<- "/home/emancini/Dropbox (CRG)/Personal_Estefania/Network/selectedEventsHs2/convTotal/"
###############################################################################
file<-"total_600.txt"
###############################################################################
nramdomPoints=seq(20,600, 20)
Oname<-gsub("\\.txt", "", file)
print(Oname)
